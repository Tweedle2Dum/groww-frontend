  ...
  return (
    <main className=" flex gap-6 flex-wrap justify-between rounded-lg">
      <div className="cart shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]  py-4 md:px-8 flex-[1]">
        <h1 className=" text-center sm:text-left text-2xl font-bold md:text-4xl">Shopping Cart</h1>
      ...
      <div className="summary px-8 py-4 flex-[0.25] shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]  ">
        <h1 className=" text-center sm:text-left text-2xl font-bold md:text-4xl">Summary</h1>
